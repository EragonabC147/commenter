...
# Get the name of the last tag or use the initial commit or describe always
last_tag=$(git describe --abbrev=0 --tags 2>/dev/null || git rev-list --max-parents=0 HEAD || git describe --always)
